---
title: Quick Start - Get started with amqp-contract in 5 minutes
description: Get amqp-contract running in 5 minutes with a complete working example. Learn how to set up RabbitMQ, define contracts, and publish/consume messages with full type safety.
---
